...
def developers_page():
     ...
     st.write(f"""
    <p>This Auto-Machine Learning App was dvevloped by Elvis Darko. Elvis Darko is a budding Data Scientist who aspires to be an Artificial Intelligence Engineer, using his skill to solve everyday societal and business challenges. <br/> Not coming from the commonly traditional computer science and mathematics background, Elvis Darko taught himself to code in Python programming language. With a fair level of coding in python, he joined the Data Science professional training program at Azubi Africa where his skills were honed and was introduced to machine learning. It was from this immensely beneficial program that Elvis came to know about Artificial Intelligence. <br/> From there, he has pursued a path of learning and training in the field. In not so long a period to come, Elvis will be one of the leading voices and faces of Artificial Intelligence in Africa and the world</p>
